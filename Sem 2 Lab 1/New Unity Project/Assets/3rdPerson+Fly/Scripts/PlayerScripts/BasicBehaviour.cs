...
public class BasicBehaviour : MonoBehaviour
{
	...
	public string sprintButton = "left shift";                // Default sprint button input name.
	...
	private void OnTriggerEnter(Collider collision)
	{
		...
		{
			Debug.Log("Enemy");
			TextMeshProUGUI act = canvas.GetComponentInChildren<TextMeshProUGUI>();
			act.text = "Enemy - fight";
		}
